    ...
    <div className="min-h-screen p-8 mt-[75px] text-gray-100">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <section className="bg-gray-800 p-6 rounded-2xl border border-gray-700 shadow-md">
          ...
          <p className="text-gray-300">{projectDescription}<a href="https://github.com/Mubassim-Khan/NASA-Space-Apps-Challenge" className="border-b-1 border-blue-300 text-blue-300" target="_blank">GitHub</a>.</p>
        </section>
